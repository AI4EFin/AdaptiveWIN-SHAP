...
if __name__ == "__main__":
    ...
    df = pd.read_csv(f"examples/datasets/empirical/dataset.csv")
    ...
    cd = ChangeDetector(model, df["Price Day Ahead"].to_numpy(dtype=np.float64), debug=False, force_cpu=True)
